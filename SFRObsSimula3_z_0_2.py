...
fileSage = 'C:/Users/Olivia/TFG-TUT/Datos_simulaciones/histograma_Sage_z_0_2.csv'
...
#plt.plot(SFRGala[indGala], ftotGala[indGala], 'g', label='Galacticus z = 0.221')
indSage = np.where(ftotSage < -7)
plt.plot(SFRSage[ftotSage < 0], ftotSage[ftotSage < 0], 'r', label='SAGE z = 0.221')


plt.legend()
plt.savefig('C:/Users/Olivia/TFG-TUT/Figuras/Obs_Galacticus_Sage_allgalaxies_z_0_2.png')
plt.show()
